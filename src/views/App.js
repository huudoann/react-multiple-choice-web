...
import StudentInfomations from '../pages/SearchStudentInformations/SearchStudentInformations';
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route exact path='/search_student_infomations' element={<StudentInfomations />} />
