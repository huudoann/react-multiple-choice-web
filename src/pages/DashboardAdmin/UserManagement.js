...
const UserManagement = () => {
    ...
    const addUser = () => {
        ...
        if (fullName.trim() !== '' && birthDate.trim() !== '' && studentId.trim() !== '' && userClass.trim() !== '') {
            setUsers(prevUsers => [...prevUsers, { name: fullName, birth: birthDate, id: studentId, class: userClass }]);
        } else {
    ...
    const editUser = (index) => {
        ...
        if (fullName !== null && birthDate !== null && studentId !== null && userClass !== null) {
            updatedUsers[index] = { name: fullName, birth: birthDate, id: studentId, class: userClass };
